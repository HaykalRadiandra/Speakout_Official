...
function settgldefa(){
    $.ajax({
        type	: "POST",		
        url		: "pages/laphariansiswa/tgldefa.php",
        dataType: "json",		
...
function setjdllap(){	
    ...
    $.ajax({
        type	: "POST",		
        url		: "pages/laphariansiswa/jdllap.php",
        data	: {
            tgltrx: tgltrx,
            tgltrx2: tgltrx2
        },
...
function tampildata(){	
    ...
    $.ajax({
        type	: "GET",		
        url		: "pages/laphariansiswa/tampildata.php",
        data	: {
            tgltrx: tgltrx,
            tgltrx2: tgltrx2
        },
...
$("#btnexport").on('click', function() {
    ...
    let url = 'pages/laphariansiswa/exportexc.php?' +
