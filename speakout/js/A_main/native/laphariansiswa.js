...
function settgldefa(){
    $.ajax({
        type	: "POST",		
        url		: "pages/laphariansiswabk/tgldefa.php",
        dataType: "json",		
...
function setjdllap(){	
    ...
    $.ajax({
        type	: "POST",		
        url		: "pages/laphariansiswabk/jdllap.php",
        data	: {
            tgltrx: tgltrx,
            tgltrx2: tgltrx2
        },
...
function tampildata(){	
    ...
    $.ajax({
        type	: "GET",		
        url		: "pages/laphariansiswabk/tampildata.php",
        data	: {
            tgltrx: tgltrx,
            tgltrx2: tgltrx2
        },
...
$("#btnexport").on('click', function() {
    ...
    let url = 'pages/laphariansiswabk/exportexc.php?' +
