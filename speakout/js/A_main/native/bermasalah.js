...
$(function() {
    ...
    $(document).on("change", "#txttglawal, #txttglakhir, #cbokelasx, #cbojurusanx, #cboindeksx, #cbojnspelanggaranx, #cbostatusx", function() {
        tampildata();
    });        
...
function tgldefault(){
    $.ajax({
        type: 'POST', 
        url: 'pages/pelanggaran/tampilkan_default.php',
        dataType: "json",
...
function isi_cbojnspelanggaran(cbojnspelanggaran) {
    $.ajax({
        type: 'POST',
        url: 'pages/pelanggaran/tampilkan_jenispelanggaran.php',
...
function isi_cbojnspelanggaranx(cbojnspelanggaranx){
    $.ajax({
        type: 'POST', 
        url: 'pages/pelanggaran/tampilkan_jenispelanggaranx.php',
        success: function(response) {
...
function isi_cbojurusan(cbojurusan){
    $.ajax({
        type: 'POST', 
        url: 'pages/pelanggaran/tampilkan_jurusan.php',
        success: function(response) {
...
function tampildata(page){
    ...
    $.ajax({
        type	: "GET",		
        url		: "pages/pelanggaran/tampildata.php",
        data	: {
            page: page,
            cari: cari,
            tglawal: tglawal,
...
function pages(page) {
    ...
    $.ajax({
        type: "GET",
        url: "pages/pelanggaran/paging.php",
        data: {
            page: page,
            cari: cari,
            tglawal: tglawal,
...
function detail(kodeaduan){		
    ...
    $.ajax({
        type	: "POST",
        url		: "pages/pelanggaran/detail.php",
...
$('#btnSetuju').on('click', function() {
	...
	$.ajax({
		type	: "POST",
		url		: "pages/pelanggaran/setujui.php",
		data	: {
            kodeaduan: kodeaduan
        },
		dataType: "json",
...
$('#btnTolak').on('click', function() {
    ...
    $.ajax({
        type	: "POST",
        url		: "pages/pelanggaran/tolak.php",
        data	: {
            kodeaduan: kodeaduan
        },
        dataType: "json",
...
$('#btnHapus').on('click', function() {
	...
	$.ajax({
		type	: "POST",
		url		: "pages/pelanggaran/hapus.php",
		data	: "kodeaduan="+kodeaduan,
		dataType: "json",
		success	: function(data){
...
function tampil_masterdata(pages){
    ...
    $.ajax({
        type	: "GET",		
        url		: "pages/pelanggaran/tampil_masterdata.php",
        data	: {
            cari: cari,
            kelas: kelas,
            jurusan: jurusan,
...
function pagesiswa(pages){
    ...
    $.ajax({
        type	: "GET",		
        url		: "pages/pelanggaran/pagingmasterdata.php",
        data	: {
            cari: cari,
            kelas: kelas,
            jurusan: jurusan,
...
function isi_cbojurusanmaster(cbojurusanmaster){
	$.ajax({
		type: 'POST', 
		url: 'pages/pelanggaran/tampilkan_jurusanmaster.php',
		success: function(response) {
...
$("#btnSave").on('click', function(){
    ...
    $.ajax({
        type: "POST",
        url: "pages/pelanggaran/simpan.php",
        data: formData,
        processData: false,
        contentType: false,
        dataType: "json",
...
$("#btnexport").on('click', function() {
    ...
    let url = 'pages/pelanggaran/exportexc.php?' +
