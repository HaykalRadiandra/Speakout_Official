...
echo " 
	<div class='container mt-2 table-responsive p-0 rounded-3'>
	...
	echo "
				...
				<tr>
					...
					<td class='text-center'>
						<a href='javascript:void(0)' onClick=\"edit('{$rec['kodesiswa']}')\">Edit</a> &nbsp;&nbsp;| &nbsp;
						<a href='javascript:void(0)' onClick=\"del('{$rec['kodesiswa']}')\">Hapus</a>
					</td>
				</tr>";	
