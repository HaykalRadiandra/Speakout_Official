...
<html>
    ...
    <body class="skin-blue">
            ...
            <aside class="right-side">
                <section class="content-header">
					...
					<ol class="breadcrumb">
                        ...
                        <li class="active">Entri edukasi</li>
                    </ol>
                </section>				
                <section class="content">
					<div class="box box-solid" id="vwdata"><br>
						<div class="box-body">							
							<div class="form-group"><br>
								...
								<div class="col-lg-6 text-right">		
									<span class="help-block"><a href="#" id="entriplgn">[&nbsp; Entri edukasi Baru &nbsp;]</a></span>
								</div>
							</div>												
						</div>
						...
						<div class="box-body">
							<div class="box-footer no-print text-right">		
								...
								<button class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Export Excel Data edukasi" onClick="printtoexcel()"><i class="fa fa-cloud-download"></i>&nbsp; Export to Excel</button>
								<button class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Print Data edukasi" onclick="window.print();"><i class="fa fa-print"></i> Print</button>
							</div>
						</div>
					</div>
					...
					<div class="box box-solid" id="endata" style="display: none;"><br>
						<div class="box-header" >
							<h4 style="font-family: 'Kaushan Script', cursive;font-size:18px;color:#CCCCCC" class="box-title">&nbsp; Form edukasi Baru</h4>							
						</div><hr>
						<br>
						<div class="box-body">
						...
						<div class="box-body">
							<div class="box-footer" >	
								<button type="button" class="btn btn-primary" onClick="window.location='?mod=entriedukasi'">
        ...
        <div class="modal fade" id="confirmhapus-modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
					...
					<input type="hidden" id="txtkodeedukasi"/>
					<div class="modal-body text-center">
		 ...
		 <div class="modal fade" id="info-modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						<h4 class="modal-title">edukasi</h4>
					</div>
		...
		<script src="js/newedukasi.js" type="text/javascript"></script>	
