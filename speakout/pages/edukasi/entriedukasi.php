...
<html>
    <head>
		...
		<link rel="stylesheet" href="css/native_styling/entri_edukasi.css">
		<title>SPEAKOUT | Entri Edukasi</title>
    </head>
    <body>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent px-4 py-4 py-md-2">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-3 m-0  primary-text">Entri Edukasi</h2>
                </div>
			...
			<div class="row m-0 mb-3" id="vwdata">
					<div class="d-flex p-0 mb-3 flex-wrap justify-content-between align-items-center gap-3 gap-sm-3 gap-lg-3">
						...
						<div class="text-end col-12 col-sm-4 col-md-4 col-lg-4">
							<span class="d-block"><a href="#" class="text-decoration-none fw-medium" id="entriedukasi">[&nbsp; Entri Edukasi Baru &nbsp;]</a></span>
						</div>
					</div>
					...
					<div class="mt-3 p-0 d-print-none">
						<div class="d-flex justify-content-between align-items-center">
							...
							<div class="d-flex justify-content-between align-items-center">
								<button class="btn btn-success me-2 d-none" data-bs-toggle="tooltip" data-bs-placement="top" title="Export Excel Data Edukasi" onClick="printtoexcel()">
									<i class="bi bi-file-earmark-spreadsheet-fill"></i>&nbsp; Export <span class="d-none d-sm-inline-block">to Excel</span>
								</button>
								<button class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Print Data Edukasi" onclick="window.print();">
                ...
                <div class="row m-0" id="endata">
					...
					<div class="container-fluid m-0 p-0 mt-3">
						<div class="mb-0 mb-sm-0 mb-md-3 d-flex justify-content-center align-items-center flex-wrap">
							...
							<div class="col-12 col-sm-8 col-md-6 mb-sm-2 mb-lg-0">
								<input type="text" id="txtjudul" class="form-control text-center input-field" autocomplete="off"
									maxlength="200"/>
							</div>
						</div>
						...
						<div class="mb-0 mb-sm-0 mb-md-3 d-flex justify-content-center align-items-center flex-wrap">
							...
							<textarea rows="3" class="form-control input-field" id="txtket" autocomplete="off"></textarea>
								<input type="hidden" class="form-control" id="txtkodeedukasi" />
							</div>
						</div>
					...
					<div class="p-0">
						<div class="d-flex justify-content-between">
							<button type="button" class="btn btn-primary me-2" onClick="window.location='?mod=entriedukasi'">
		...
		<script src="js/A_main/native/entriedukasi.js"></script>
