...
// Query jumlah data
$queryCount = "SELECT COUNT(*) AS jumData FROM guru WHERE onview=1 ";
if ($cari) $queryCount .= "AND (nama LIKE '%$cari%' OR nip LIKE '%$cari%' OR alamat LIKE '%$cari%' OR notelp LIKE '%$cari%') ";
