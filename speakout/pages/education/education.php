...
<html>
    <head>
		...
		<link rel="stylesheet" href="css/native_styling/edukasi.css">
		<title>SPEAKOUT | Edukasi</title>
    </head>
    <body>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent px-4 py-4 py-md-2">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-3 m-0  primary-text">Edukasi</h2>
                </div>
            ...
            <div class="container-fluid p-4">
				<div class="row m-0 mb-3" id="vwdata">
					<div class="d-flex p-0 mb-2 flex-wrap justify-content-between align-items-center gap-3 gap-sm-3 gap-lg-3">
						...
						<div class="text-end col-12 col-sm-4 col-md-4 col-lg-4 d-flex gap-3 justify-content-end">
							<button class="btn btn-outline-primary active" value="1">Terbaru</button>
							<button class="btn btn-outline-primary" value="2">Terlama</button>
						</div>
					</div>

                </div>
                <!-- Awal struktur card -->
				<div class="row m-0 mb-3" id="endata">
					<div class="col-12 p-0 mb-3">
						<div class="mt-2 d-flex gap-3 flex-wrap justify-content-between" id="tampildata">
				...
				<div class="modal-dialog modal-dialog-centered modal-lg">
					<div class="modal-content bg-transparent border-0">
						<div class="modal-body text-center p-0">
							<img src="" class="img-fluid rounded-3 w-75" id="modalImage" alt="Preview Gambar">
						</div>
					</div>
				</div>
			</div>
		...
		<script src="js/A_main/native/edukasi.js"></script>
