...
// Query jumlah data
$queryCount = "SELECT COUNT(*) AS jumData FROM cerita a LEFT JOIN siswa b ON a.kodesiswa=b.kodesiswa LEFT JOIN jurusan c 
			ON b.kodejurusan=c.kodejurusan LEFT JOIN guru d ON a.kodeguru=d.kodeguru WHERE a.onview=1 ";
if ($cari) $queryCount .= "AND (b.nama LIKE '%$cari%' OR d.nama LIKE '%$cari%' ) ";
if ($kategori) $queryCount .= " AND a.kategori='$kategori' ";
