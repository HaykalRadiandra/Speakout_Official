...
<html> 
    <head>
        <meta charset="UTF-8">
        <title>Speakout | Jenis Pelanggaran</title>
    ...
    <body class="skin-blue">
                ...
                <section class="content">
					<div class="box box-solid"><br>
						<div class="box-header" >
							<h4 style="font-family: 'Kaushan Script', cursive;font-size:18px;color:#CCCCCC" class="box-title">&nbsp; Form Entri Jenis Pelanggaran</h4>							
						</div><hr>
						<br>
						<div class="box-body">
							<form class="form-horizontal">
								<div class="form-group">	
									<div class="col-lg-6">
										...
										<div class="col-sm-4">
											<select id="cbotingkatx" class="form-control selectme">
												<option value='' selected>- Berat Pelanggaran -</option>
										...
										<div class="table-responsive">
											<table class='table table-bordered'>
												<thead style='background-color:#f9f9f9'>
													<tr>
													    <th rowspan="2" style="width:5%; vertical-align:middle;" class="text-center">NO</th>
													    <th style="vertical-align:middle;" class="text-center">NAMA PELANGGARAN</th>
														<th style="width:15%;vertical-align:middle;" class="text-center">BERAT PELANGGARAN</th>
													...
													<tr>
													    ...
													    <td>
													        <input type="text" class="form-control text-left" id="txtnama" />
													    </td>
														<td>
															<select id="cbotingkat" class="form-control selectme">
		...
		<script src="js/newjnspelanggaran.js?v=2.0.0" type="text/javascript"></script>	
