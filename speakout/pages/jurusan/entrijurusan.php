...
<html>
    <head>
		...
		<link rel="stylesheet" href="css/native_styling/entri_jurusan.css">
    ...
    <body>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent px-4 py-4 py-md-2 d-print-none">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-3 m-0  primary-text">Entri Jurusan</h2>
                </div>
            ...
            <div class="container-fluid p-4">
                <div class="row m-0" id="endata">
					...
					<div class="d-flex p-0 mt-3 mb-3 flex-wrap justify-content-start gap-3 gap-sm-3 gap-lg-3 d-print-none">
							...
							<table class="table table-bordered align-middle mb-0">
								<thead class="table-light">
									...
									<tr class="d-print-none">
										...
										<td>
											<input type="text" class="form-control" id="txtnamajurusan" placeholder="Masukkan Nama Jurusan"/>
										</td>
					...
					<div class="mt-3 p-0 d-print-none">
						<div class="d-flex justify-content-between align-items-center">
							...
							<div class="d-flex justify-content-between align-items-center">
								<button class="btn btn-success me-2 d-none" data-bs-toggle="tooltip" data-bs-placement="top" title="Export Excel Data Jurusan" onClick="printtoexcel()">
									<i class="bi bi-file-earmark-spreadsheet-fill"></i>&nbsp; Export <span class="d-none d-sm-inline-block">to Excel</span>
								</button>
								<button class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Print Data Jurusan" onclick="window.print();">
		...
		<script src="js/A_main/native/entrijurusan.js"></script>
