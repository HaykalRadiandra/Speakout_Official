...
<html>
    <head>
		...
		<link rel="stylesheet" href="css/native_styling/entri_kehilangan.css">
		<title>SPEAKOUT | Kehilangan</title>
    </head>
    <body>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent px-4 py-4 py-md-2">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-3 m-0  primary-text">Kehilangan</h2>
                </div>
			...
			<div class="container-fluid p-4">
				...
				<div class="row m-0 mb-3" id="vwdata">
					<div class="d-flex p-0 mb-3 flex-wrap justify-content-between align-items-center gap-3 gap-sm-3 gap-lg-3">
						...
						<div class="text-end col-12 col-sm-12 col-md-6 col-lg-3">
							<span class="d-block"><a href="#" class="text-decoration-none fw-medium" id="entrikehilangan">[&nbsp; Entri Kehilangan Baru &nbsp;]</a></span>
						</div>
					</div>
					...
					<div class="mt-3 p-0 d-print-none">
						<div class="d-flex justify-content-between align-items-center">
							...
							<div class="d-flex justify-content-between align-items-center">
								<button class="btn btn-success me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Export Excel Data Kehilangan" id="btnexport">
									<i class="bi bi-file-earmark-spreadsheet-fill"></i>&nbsp; Export <span class="d-none d-sm-inline-block">to Excel</span>
								</button>
								<button class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Print Data Kehilangan" onclick="window.print();">
                ...
                <div class="row m-0" id="endata">
					...
					<div class="container-fluid m-0 p-0 mt-3">
						<div class="mb-0 mb-sm-0 mb-md-3 d-flex justify-content-center align-items-center flex-wrap">
							...
							<div class="col-12 col-sm-8 col-md-6 mb-sm-2 mb-lg-0">
								...
								<input type="hidden" class="form-control" id="txtkodekehilangan" />
							</div>
						</div>

						<div class="mb-0 mb-sm-0 mb-md-3 d-flex justify-content-center align-items-start flex-wrap">
							<label for="txtfoto" class="col-12 col-sm-3 col-md-3 col-lg-2 text-lg-start col-form-label">Lampiran</label>
					...
					<div class="p-0">
						<div class="d-flex justify-content-between">
							<button type="button" class="btn btn-primary me-2" onClick="window.location='?mod=aduankehilangan'">
		...
		<!-- Modal Confirm Ketemu -->
		<div class="modal fade" id="confirmKetemu" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="confirmKetemuLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h1 class="modal-title fs-4" id="confirmKetemuLabel">Konfirmasi</h1>
				...
				<div class="modal-body text-center">
					...
					<div class="modal-footer d-flex justify-content-between">
						...
						<button type="button" class="btn btn-success d-flex align-items-center gap-1 fw-medium" id="btnKetemu"><i class="bi bi-check-lg"></i>Ya</button>
					</div>
				</div>
			</div>
		</div>
		...
		<script src="js/A_main/native/entrikehilangan.js"></script>
