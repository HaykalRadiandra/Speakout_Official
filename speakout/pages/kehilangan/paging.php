...
// Query jumlah data
$queryCount = "SELECT COUNT(*) AS jumData FROM kehilangan a LEFT JOIN siswa b ON b.kodesiswa=a.kodepelapor LEFT JOIN jurusan c ON c.kodejurusan=b.kodejurusan LEFT JOIN guru d ON d.kodeguru=a.kodepelapor WHERE a.onview=1 
    AND DATE_FORMAT(a.tglentry,'%Y-%m-%d')>='$tglawal' AND DATE_FORMAT(a.tglentry,'%Y-%m-%d')<='$tglakhir' ";
