	...
	<table class='table table-hover'>
		<thead>
			<tr>
				...
				<th colspan=5 class='third-bg text-center align-middle'>Topik</th>	
			</tr>
			<tr>								
				...
				<th class='third-bg text-center align-middle'>Pribadi</th>
				<th class='third-bg text-center align-middle'>Belajar</th>
				<th class='third-bg text-center align-middle'>Sosial</th>
				<th class='third-bg text-center align-middle'>Karir</th>
				<th class='third-bg text-center align-middle'>Total</th>
			</tr>
		</thead>
		<tbody>";		
		...
		while($rec = mysqli_fetch_array($sql)){		
			...
			echo "
				<tr>
					...
					<td class='text-center'>$rec[pribadi]</td>
					<td class='text-center'>$rec[belajar]</td>
					<td class='text-center'>$rec[sosial]</td>
					<td class='text-center'>$rec[karir]</td>
					<td class='text-center'>$rec[totaltopik]</td>
			...
			$grandpribadi += $rec['pribadi'];
			$grandbelajar += $rec['belajar'];
			$grandsosial += $rec['sosial'];
			$grandkarir += $rec['karir'];
			$grandtotaltopik += $rec['totaltopik'];
...
echo "	</tbody>
		<tfoot>	
			<tr>
				...
				<td class='text-center'><b>$grandpribadi</b></td>
				<td class='text-center'><b>$grandbelajar</b></td>
				<td class='text-center'><b>$grandsosial</b></td>
				<td class='text-center'><b>$grandkarir</b></td>
				<td class='text-center'><b>$grandtotaltopik</b></td>
			</tr>
		</tfoot>		
	</table>";	
?>