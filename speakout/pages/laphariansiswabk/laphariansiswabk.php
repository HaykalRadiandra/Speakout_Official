...
<html>
    <head>
		...
		<link rel="stylesheet" href="css/native_styling/laphariansiswa.css">
		<title>SPEAKOUT | Lap Harian Siswa</title>
    </head>
    <body>
                ...
                <div class="row m-0" id="endata">
					...
					<div class="mt-3 p-0 d-print-none">
						<div class="d-flex justify-content-between align-items-center">
							...
							<div class="d-flex justify-content-between align-items-center">
								<button class="btn btn-success me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Export Excel Data Laporan Siswa" id="btnexport">
									<i class="bi bi-file-earmark-spreadsheet-fill"></i>&nbsp; Export <span class="d-none d-sm-inline-block">to Excel</span>
								</button>
								<button class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Print Data Laporan Siswa" onclick="window.print();">
		...
		<script src="js/A_main/native/laphariansiswa.js"></script>
