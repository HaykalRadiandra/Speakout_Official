...
<html>
    <head>
		...
		<link rel="stylesheet" href="css/native_styling/entri_hukuman.css">
    ...
    <body>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent px-4 py-4 py-md-2">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-3 m-0  primary-text">Data Hukuman</h2>
                </div>
			...
			<?php if ($_SESSION['jenisuser'] == 1) {?>
				<div class="row m-0 mb-3" id="vwdata">
					<div class="d-flex p-0 mb-3 flex-wrap justify-content-between gap-3 gap-sm-3 gap-lg-3">
						...
						<div class="col-12 col-sm-3 col-md-4 col-lg-2">
							<select class="form-select fw-medium" id="cboterlapor">
								<option value='1' selected>Terlaporkan</option>
								<option value='2'>Pelapor</option>
							</select>
						</div>
					</div>

					<div class="col-12 p-0 mb-3 mt-2">
					...
					<div class="mt-3 p-0 d-print-none">
						<div class="d-flex justify-content-between align-items-center">
							...
							<div class="d-flex justify-content-between align-items-center">
								<button class="btn btn-success me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Export Excel Data Hukuman" id="btnexport">
									<i class="bi bi-file-earmark-spreadsheet-fill"></i>&nbsp; Export <span class="d-none d-sm-inline-block">to Excel</span>
								</button>
								<button class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Print Data Hukuman" onclick="window.print();">
                ...
                <div class="row m-0" id="endata">
					...
					<div class="container-fluid m-0 p-0 mt-3">
						<div class="mb-0 mb-sm-0 mb-md-3 d-flex justify-content-center align-items-center flex-wrap">
							...
							<div class="col-12 col-sm-8 col-md-6 mb-sm-2 mb-lg-0">
								<input type="text" id="cbosiswa" class="form-control text-center input-field" placeholder="tekan form ini untuk memilih nama siswa" autocomplete="off" readonly/>
						...
						<div class="mb-0 mb-sm-0 mb-md-3 d-flex justify-content-center align-items-center flex-wrap">
							<label for="txtkethukuman" class="col-12 col-sm-3 col-md-3 col-lg-2 text-lg-start col-form-label">Hukuman</label>
							<div class="col-12 col-sm-8 col-md-6 mb-sm-2 mb-lg-0">
								<textarea rows="3" class="form-control input-field" id="txtkethukuman" maxlength="200" autocomplete="off"></textarea>
							</div>
						</div>

						<div class="mb-0 mb-sm-0 mb-md-3 d-flex justify-content-center align-items-start flex-wrap">
							<label class="col-12 col-sm-3 col-md-3 col-lg-2 text-lg-start col-form-label" id="txtlampiran">Lampiran</label>
					...
					<div class="p-0">
						<div class="d-flex justify-content-between">
							<button type="button" class="btn btn-primary me-2" onClick="window.location='?mod=hukuman'">
		...
		<script src="js/A_main/native/entrihukuman.js"></script>
