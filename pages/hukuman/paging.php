...
if($jenisuser==1 && $terlapor==1){
	$queryCount .= " AND a.kodeterlapor='$kodeuser' ";
} elseif ($jenisuser==1 && $terlapor==2) {
    $queryCount .= " AND a.kodepelapor='$kodeuser' ";
}
if ($cari) $queryCount .= " AND (e.ket LIKE '%$cari%' OR b.nama LIKE '%$cari%' OR d.nama LIKE '%$cari%') ";
