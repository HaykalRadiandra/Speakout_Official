    ...
    <table class='table table-hover'>
        <thead>
            <tr>
                ...
                <th class='third-bg text-center'>Nama Siswa</th>
...
while($rec = mysqli_fetch_array($sql)) {
    ...
    echo "
            <tr>
                ...
                <td>
                    <a class='text-decoration-none' href='javascript:void(0)' onClick=\"isi_cbosiswa('$rec[kodesiswa]','$rec[nama]','$rec[kelas]')\">$rec[nama]</a>
                </td>
