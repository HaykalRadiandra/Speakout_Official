...
<html>
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                <section class="content-header">
					...
					<ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-clipboard"></i>Aduan</a></li>
                        <li class="active">Entri Pelanggaran</li>
                    </ol>
                </section>				
						...
						<div class="box-body">
							<div class="form-group"><br>
								...
								<div class="col-lg-2 text-right">		
									<span class="help-block"><a href="#" id="addpenc">[&nbsp; Entri Aduan &nbsp;]</a></span>
								</div>
							</div>												
						</div>
					...
					<div class="box box-solid" id="endata" style="display: none;"><br>
						...
						<div class="box-body">
							<div class="box-footer" >	
								<button type="button" class="btn btn-primary" onClick="window.location='?mod=aduanpelanggaran'">
		...
		<script src="js/newpelanggaran.js" type="text/javascript"></script>	
