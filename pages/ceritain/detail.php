...
$detail = query("SELECT a.kodecerita,a.tglajuan,a.kategori,b.nama AS namasiswa,d.nama AS namaguru,a.descr,a.kategori,a.tipe,b.kelas AS kelas,CONCAT(c.nama,' ',b.indeks) AS jurusan,a.status FROM cerita a LEFT JOIN siswa b ON a.kodesiswa=b.kodesiswa LEFT JOIN jurusan c 
...
$via = $row['tipe'] == 1 ? "Chat / Online" : "Temu / Offline";
