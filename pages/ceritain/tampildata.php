...
$text 	= "SELECT a.kodesiswa,a.kodecerita,a.tglajuan,a.kategori,b.nama AS namasiswa,d.nama AS namaguru,a.descr,a.kategori,a.tipe,CONCAT(b.kelas,' ',c.nama,' ',b.indeks) AS kelas,a.status FROM cerita a LEFT JOIN siswa b ON a.kodesiswa=b.kodesiswa LEFT JOIN jurusan c 
...
while ($rec = mysqli_fetch_array($sql)) {
	...
	$kategori = $rec['kategori'] == 1 ? "Konsultasi" : "Konseling";
