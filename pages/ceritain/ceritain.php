				...
				<?php if($_SESSION['jenisuser'] == 1) {?>
					<div class="row m-0" id="endatasiswa">
						...
						<div class="container-fluid m-0 p-0 mt-3">
							...
							<div class="mb-0 mb-sm-0 mb-md-3 d-flex justify-content-center align-items-center flex-wrap">
								<label for="cbokategori" class="col-12 col-sm-3 col-md-3 col-lg-2 text-lg-start col-form-label">Kategori</label>
								<div class="col-12 col-sm-8 col-md-6 mb-sm-2">
									<select id="cbokategori" class="form-select select2me input-field">
							...
							<div class="mb-0 mb-sm-0 mb-md-3 d-flex justify-content-center align-items-center flex-wrap">
								<label for="cbotype" class="col-12 col-sm-3 col-md-3 col-lg-2 text-lg-start col-form-label">Metode</label>
								<div class="col-12 col-sm-8 col-md-6 mb-sm-2">
									<select id="cbotype" class="form-select select2me input-field">
										<option value="" selected>- Silahkan Pilih -</option>
							...
							<div class="mb-0 mb-sm-0 mb-md-3 d-flex justify-content-center align-items-center flex-wrap">
								...
								<div class="col-12 col-sm-8 col-md-6 mb-sm-2 mb-lg-0">
									<textarea rows="3" class="form-control input-field" id="txtdes" maxlength="200" autocomplete="off"></textarea>
								</div>
							</div>
						</div>
				...
				<?php } else { ?>
					<div class="row m-0 mb-3" id="vwdata">
						<div class="d-flex p-0 mb-4 flex-wrap justify-content-between align-items-center gap-3 gap-sm-3 gap-lg-3">
							...
							<div class="text-end col-12 col-sm-12 col-md-6 col-lg-2">
