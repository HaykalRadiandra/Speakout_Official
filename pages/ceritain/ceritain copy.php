    ...
    <body class="skin-blue">
        <header class="header">
            <a href="index.html" class="logo">
				<?php				
					session_start();
					include "/www/wwwroot/speakout/inc/inc.koneksi.php";
					include "/www/wwwroot/speakout/inc/fungsi_hdt.php";
                ...
                <section class="content">
					<div class="box box-solid" id="vwdata"><br>
						<div class="box-body">							
							<div class="form-group"><br>
								...
								<div class="col-lg-6 text-right">		
									<span class="help-block"><a href="#" id="entriplgn">[&nbsp; Entri Guru Baru &nbsp;]</a></span>
								</div>
							</div>												
						</div>
						...
						<div class="box-body">
							<div class="box-footer no-print text-right">		
								<button type="button" class="btn btn-primary pull-left" onClick="window.location='?mod=guru'">
									<i class="fa  fa-dot-circle-o"></i>&nbsp;Tutup</button>
								<button class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Export Excel Data Guru" onClick="printtoexcel()"><i class="fa fa-cloud-download"></i>&nbsp; Export to Excel</button>
								<button class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Print Data Guru" onclick="window.print();"><i class="fa fa-print"></i> Print</button>
							</div>
						</div>
					</div>
					...
					<div class="box box-solid" id="endata" style="display: none;"><br>
						<div class="box-header" >
							<h4 style="font-family: 'Kaushan Script', cursive;font-size:18px;color:#CCCCCC" class="box-title">&nbsp; Form Guru Baru</h4>							
						</div><hr>
						<br>
						<div class="box-body">
						...
						<div class="box-body">
							<div class="box-footer" >	
								<button type="button" class="btn btn-primary" onClick="window.location='?mod=entriguru'">
		...
		<script src="js/newguru.js" type="text/javascript"></script>	
