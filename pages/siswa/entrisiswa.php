...
<html>
    <head>
		...
		<link rel="stylesheet" href="css/native_styling/entri_siswa.css">
    ...
    <body>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent px-4 py-4 py-md-2 d-print-none">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-3 m-0  primary-text">Entri Siswa</h2>
                </div>
            ...
            <div class="container-fluid p-4">
				<div class="row m-0 mb-3" id="vwdata">
					<div class="d-flex p-0 mb-3 flex-wrap justify-content-between gap-3 gap-sm-3 gap-lg-3 d-print-none">
						...
						<div class="text-end col-12 col-sm-12 col-md-6 col-lg-12">
							<span class="d-block"><a href="#" class="text-decoration-none fw-medium" id="entrisswa">[&nbsp; Entri Siswa Baru &nbsp;]</a></span>
						</div>
					</div>
					...
					<div class="mt-3 p-0 d-print-none">
						<div class="d-flex justify-content-between align-items-center">
							...
							<div class="d-flex justify-content-between align-items-center">
								<button class="btn btn-success me-2 d-none" data-bs-toggle="tooltip" data-bs-placement="top" title="Export Excel Data Siswa" onClick="printtoexcel()">
									<i class="bi bi-file-earmark-spreadsheet-fill"></i>&nbsp; Export <span class="d-none d-sm-inline-block">to Excel</span>
								</button>
								<button class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Print Data Siswa" onclick="window.print();">
                ...
                <div class="row m-0" id="endata">
					<div class="mb-2 p-0">
						<h4 class="text-secondary fs-5 fw-semibold" style="font-family: 'Kaushan Script', cursive;">
							&nbsp; Form Siswa Baru
						</h4>
					</div>
					<hr>
					...
					<div class="container-fluid m-0 p-0 mt-3">
						...
						<div class="mb-0 mb-sm-0 mb-md-3 d-flex justify-content-center align-items-center flex-wrap">
							<label class="col-12 col-sm-3 col-md-3 col-lg-2 text-lg-start col-form-label">Nama Siswa</label>
							<div class="col-12 col-sm-8 col-md-6 mb-sm-2">
						...
						<div class="mb-0 mb-sm-0 mb-md-3 d-flex justify-content-center align-items-center flex-wrap">
							<label class="col-12 col-sm-3 col-md-3 col-lg-2 text-lg-start col-form-label">NIS</label>
							<div class="col-12 col-sm-8 col-md-6 mb-sm-2">
								<input type="text" class="form-control text-center input-field" id="txtnis" maxlength="50" />
							</div>
						</div>

						<div class="mb-0 mb-sm-0 mb-md-3 d-flex justify-content-center align-items-center flex-wrap">
							<label class="col-12 col-sm-3 col-md-3 col-lg-2 text-lg-start col-form-label">NISN</label>
							<div class="col-12 col-sm-8 col-md-6 mb-sm-2">
								<input type="text" class="form-control text-center input-field" id="txtnisn" maxlength="50" />
							</div>
						</div>

						<div class="mb-0 mb-sm-0 mb-md-3 d-flex justify-content-center align-items-center flex-wrap">
							<label class="col-12 col-sm-3 col-md-3 col-lg-2 text-lg-start col-form-label">Masa Sekolah</label>
							<div class="col-12 col-sm-8 col-md-6 mb-sm-2">
								<select id="cbomasasekolah" class="form-select input-field">
									<option value="3">3</option>
									<option value="4">4</option>
								</select>
							</div>
						...
						<div class="mb-0 mb-sm-0 mb-md-3 d-flex justify-content-center align-items-center flex-wrap">
							<label class="col-12 col-sm-3 col-md-3 col-lg-2 text-lg-start col-form-label">Kelas</label>
							<div class="col-12 col-sm-8 col-md-6 mb-sm-2">
								<select id="cbokelas" class="form-select input-field">
						...
						<div class="mb-0 mb-sm-0 mb-md-3 d-flex justify-content-center align-items-center flex-wrap">
							<label class="col-12 col-sm-3 col-md-3 col-lg-2 text-lg-start col-form-label">Jurusan</label>
							<div class="col-12 col-sm-8 col-md-6 mb-sm-2">
								<select id="cbojurusan" class="form-select select2me input-field">
						...
						<div class="mb-0 mb-sm-0 mb-md-3 d-flex justify-content-center align-items-center flex-wrap">
							<label class="col-12 col-sm-3 col-md-3 col-lg-2 text-lg-start col-form-label">Indeks</label>
							<div class="col-12 col-sm-8 col-md-6 mb-sm-2">
								<select id="cboindeks" class="form-select input-field">
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
						...
						<div class="mb-0 mb-sm-0 mb-md-3 d-flex justify-content-center align-items-center flex-wrap">
							<label class="col-12 col-sm-3 col-md-3 col-lg-2 text-lg-start col-form-label">Tanggal Lahir</label>
							<div class="col-12 col-sm-8 col-md-6 mb-sm-2">
								<div class="input-group">
									<span class="input-group-text"><i class="bi bi-calendar-week"></i></span>
									<input type="text" style="background:#FFFFFF" id="txttgllahir" class="datepickerr form-control text-center input-field" readonly />
								</div>
							</div>
						</div>
					</div>
					...
					<div class="p-0">
						<div class="d-flex justify-content-between">
							<button type="button" class="btn btn-primary me-2" onClick="window.location='?mod=entrisiswa'">
		...
		<script src="js/A_main/native/entrisiswa.js"></script>
