...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Speakout | Entri Kehilangan</title>
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                <section class="content-header">
                    <h1>Entri Kehilangan</h1>
					<ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-users"></i>Aduan</a></li>
                        <li class="active">Entri Kehilangan</li>
                    </ol>
                </section>				
                <section class="content">
					<div class="box box-solid" id="vwdata"><br>
						<div class="box-body">							
							...
							<div class="col-lg-3">
								...
								<div class="col-lg-6 text-right">		
									<span class="help-block"><a href="#" id="entriplgn">[&nbsp; Entri Kehilangan Baru &nbsp;]</a></span>
								</div>
							</div>												
						</div>
						...
						<div class="box-body">
							<div class="box-footer no-print text-right">		
								...
								<button class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Export Excel Data kehilangan" onClick="printtoexcel()"><i class="fa fa-cloud-download"></i>&nbsp; Export to Excel</button>
								<button class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Print Data kehilangan" onclick="window.print();"><i class="fa fa-print"></i> Print</button>
							</div>
						</div>
					</div>
					...
					<div class="box box-solid" id="endata" style="display: none;"><br>
						<div class="box-header" >
							<h4 style="font-family: 'Kaushan Script', cursive;font-size:18px;color:#CCCCCC" class="box-title">&nbsp; Form Kehilangan Baru</h4>							
						</div><hr>
						<br>
						<div class="box-body">
						...
						<div class="box-body">
							<div class="box-footer" >	
								<button type="button" class="btn btn-primary" onClick="window.location='?mod=aduankehilangan'">
        ...
        <div class="modal fade" id="confirmhapus-modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
					...
					<input type="hidden" id="txtkodekehilangan"/>
					<div class="modal-body text-center">
		...
		<!-- Pop Up konfirmasi ketemu -->
        <div class="modal fade" id="confirmketemu-modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					...
					<div class="modal-body text-center">
						<h3>Yakin sudah ketemu ?</h3>							
					</div>
					<div class="modal-footer clearfix" id="btnexec">						
						<button type="button" class="btn btn-primary" id="btnketemu"><i class="fa fa-check"></i> Ya</button>
						<button type="button" class="btn btn-danger pull-left" data-dismiss="modal"><i class="fa fa-times"></i> Tidak</button>
					</div>					
                </div>
            </div>
		...
		<script src="js/newkehilangan.js" type="text/javascript"></script>	
